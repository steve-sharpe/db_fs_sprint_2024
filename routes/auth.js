...
// Route: GET /auth - Display the login page
...
// Route: GET /auth/new - Display the register page
router.get('/new', async (req, res) => {
    res.render('register', { status: req.session.status });
    return;
});

// Route: POST /auth/new - Handle registration
...
// Route: GET /auth/exit - Clear the session and logout
